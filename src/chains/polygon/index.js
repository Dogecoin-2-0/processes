        ...
        for (const log of logs) {
          ...
          if (isERC20 && log.topics[1] !== undefined && log.topics[2] !== undefined) {
            ...
            transactionDetail = {
              ...
              amount:
                log.address !== '0x0000000000000000000000000000000000001010'
                  ? log.data / 10 ** decimals
                  : this.web3.utils.fromWei(tx.value),
              is_erc_20: log.address !== '0x0000000000000000000000000000000000001010',
              contract_address: log.address !== '0x0000000000000000000000000000000000001010' ? log.address : undefined,
              timestamp
            };
